...
#include "../aplicativo/homewidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HomeWidget_t, stringdata) + ofs \
...
const QMetaObject HomeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HomeWidget.data,
      qt_meta_data_HomeWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HomeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HomeWidget.stringdata))
