<?php
  ...
  echo "<div id='base_corpo'>";
    echo "<div style='border: 1px solid #000000; padding: 5px; margin-bottom: 5px;'>";
      echo "ORÇAMENTOS EM ABERTO";
    echo "</div>";
    if(is_blank($cliente->orcamentos_abertos()) == 'sim'):
      echo "<div id='orcamentos_abertos' style='width: 100%; color: #ff0000;'>Nenhum registro encontrado.</div>";
    endif;
    foreach ($cliente->orcamentos_abertos() as $orcamento):
      echo "<div id='orcamentos_abertos' style='width: 100%;'>";
        echo "{$orcamento->to_s()}&nbsp;";
